[home](http://tiny.cc/fss2016) | [copyright](https://github.com/txt/fss16/blob/master/LICENSE.md) &copy;2016  tim&nbsp;@menzies.us<br>
...
NcState, ComSci   
Fall 2016   
Class 111691 (500-level), 12163 (700-level)   
EE I, Roon 1005,  
Wednesday, 6 to 8:45pm
...
[https://fss16.slack.com/messages](https://fss16.slack.com). Students are strongly encouraged to contribute their questions and answers to that shared resource.
+ Note that, for communication of a more private nature, contact the lecturer on the email shown above.

**Topics:** What is software science? Differences to data science?  Tools (data
miners). Methods (visualizations, statistics). Verification methods
(reproduction packages). Ethics. Tutorials on scripting.



**Project:** Students will implement and reason about some SE data
of their own choosing. Note that:

+ CSC 791 Ph.d. student will tackle a more intricate task;
+ CSC 591 masters students will work in groups of two to achieve a somewhat less
intricate goals.
...
such as Java or C/C++ or Python.  Significant software industry
