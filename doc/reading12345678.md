...
How to read a research paper (in software engineering)
...
Video: https://vimeo.com/136412506 . Ignore all the material about grabbing data.
...
again with some other 2011 paper. Note that, by the time you get to Part3, it
